...
import type { DiscordMessage, DiscordEmbed } from "../translation-challenge/common/discord";
...
export default function Notification() {
    ...
    return (
        <div className="flex flex-col gap-8">
            ...
            {successMessage && (
                <Alert color="success" variant="flat" onClose={() => setSuccessMessage(null)}>
                    {successMessage}
                </Alert>
            )}
            ...
            <Card className="max-w-lg p-4">
                <CardHeader className={`text-lg font-bold ${title({ color: "blue", size: "sm" })}`}>
                    Discord
                </CardHeader>
                <CardBody>
                    <div className="flex flex-col gap-6">
                        ...
                        <Button
                            ...
                            onPress={handleSend}
                            isLoading={isLoading}
                            isDisabled={isLoading || !webhookUrl.trim() || !embedTitle.trim() || !embedDescription.trim()}
                        >
                            Send Message
                        </Button>
                    </div>
